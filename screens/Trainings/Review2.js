...
const Review2 = ({route, navigation}) => {
  ...
  useEffect( () => {
    ...
    if (WordsStepper.length <= 1) {
      fetch(`${global.apiUrl}/dictionaries/review_2`, {
        method: 'GET',
        headers: {
            'Cookie': 'cookie',
        }
  ...
  function sendAnswerContainerToServer ( answerArrayForServer2 ) {
    ...
    return (
      <Item
        ...
        onPress={() => {
          ...
          answerArrayForServer2.push(answerContainerForServer);
      ...
      >
        ...
        >
          ...
          <View style={[styles.container, {backgroundColor: "#20293d"}]}>
            ...
            <View style={styles.resultButton}>
                <TouchableOpacity style={styles.signIn} onPress={() => {
                  sendAnswerContainerToServer ( answerArrayForServer2 );
